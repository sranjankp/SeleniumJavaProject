...
public class softwaretesterPrince {

		  @Given("^I am a \"([a-zA-Z]{1,})\" software tester$")
		    public void i_am_a_good_software_tester(String Typesoftwaretester){
			  
			  System.out.println(" 1. I am a "+Typesoftwaretester+" software tester");
